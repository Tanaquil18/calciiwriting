...
},
{
  "id": "sec-act-5-2-2",
  "level": "1",
  "url": "sec-act-5-2-2.html",
  "type": "Section",
  "number": "1.6",
  "title": "Proposed Activity 5.2.3",
  "body": " Proposed Activity 5.2.3     Suppose that and .  We will explore from numerical, graphical, and algebraic perspectives.      What is the key relationship between and , according to the Second FTC?  Recall that we know a function whose derivative is , namely , but we haven't yet encountered an elementary function whose derivative is .    Recall the statement of the Second FTC.    .    , by the Second FTC.       Analyze the first derivative of algebraically to determine the intervals on which is increasing and decreasing.    Where is positive? negative?    is increasing for all ; is decreasing for    is increasing wherever is positive, so for all . Similarly, is decreasing for      Analyze the second derivative of algebraically to determine the intervals on which is concave up and concave down. Note that can be simplified to be written in the form .    Note that .    is CCU on and CCD for and .    is CCU wherever is increasing or wherever is positive. It is straightforward to show that is positive for and negative otherwise, thus is CCU on and CCD for and .      Use a Riemann sum calculator with midpoints and 10 subintervals to calculate approximate values of in the table shown below.  Note that .                     0        Remember that .                     2.35973  1.64038  0  1.64038  2.35973      , using a midpoint Riemann sum with 10 subintervals. Similarly, , and , and finally       Use your work above to sketch an accurate graph of on the axes provided below.   Axes for plotting   Axes for plotting the graph of F               Use the table of values along with the intervals where is increasing, decreasing, concave up and concave down.     Axes for plotting   Axes for plotting the graph of F    f(x)=1\/2*log(1+x^2)            Using the values and information we've found in (b)-(d), we arrive at the figure in the answer.      Now consider the function . Calculate and . Use appropriate computing technology to plot the graph of . What can you conclude about the functions and ?    Use the chain rule to calculate , and note that .     and .     The function has derivative and . As further confirmed by graphing and together, the functions and are the same function, described in different ways.         Consider the function .  Let be the degree Taylor approximation of about .  Use 4 decimal places in your two answers below, but make sure you carry all decimals when performing calculations.  Calculate:      is an  over   under  estimate of .  Using the Lagrange Error Bound for , calculate:                         SOLUTION  The degree approximation of about is given by:   ,  ,  .  Therefore,  ,  ,  is always positive in the interval [1,1.02] so is a overestimate of .  Using the Lagrange Error Bound we find an M such that:  , where for all in the interval [1,1.02].  By examining we find that it is biggest when . Therefore, a suitable choice is .  By calculation we find: .           Consider the function .  Let be the degree Taylor approximation of about .  Use 4 decimal places in your two answers below, but make sure you carry all decimals when performing calculations.  Calculate:      is an  over   under  estimate of .  Using the Lagrange Error Bound for , calculate:                         SOLUTION  The degree approximation of about is given by:   ,  ,  .  Therefore,  ,  ,  is always negative in the interval [8,9] so is a underestimate of .  Using the Lagrange Error Bound we find an M such that:  , where for all in the interval [8,9].  By examining we find that it is biggest when . Therefore, a suitable choice is .  By calculation we find: .           Consider the function .  Let be the degree Taylor approximation of about .  Use 3 decimal places in your three answers below, but make sure you carry all decimals when performing calculations.  Calculate:        is an  over   under  estimate of .  Using the Lagrange Error Bound for , calculate:                              SOLUTION  The degree approximation of about is given by:   ,  ,  ,  .  Therefore,  ,  ,  ,  is always negative in the interval [1,2] so is a underestimate of .  Using the Lagrange Error Bound we find an M such that:  , where for all in the interval [1,2].  By examining we find that it is biggest when . Therefore, a suitable choice is .  By calculation we find: .           Consider the function .  Let be the degree Taylor approximation of about .  Find:        Use 3 decimal places in your answer, but make sure you carry all decimals when performing calculations  is an (over\/under) estimate of .  If is the remainder given by the Lagrange Remainder Formula:                              SOLUTION  The degree approximation of about is given by:   ,  ,  ,  .  Therefore,  ,  ,  ,  is always negative in the interval [1,2] so is a underestimate of .  By the Legrange Remainder Theorem we know we can find an M such that:  , where for all in the interval [2,1].  By examining we find that it is biggest when . Therefore, a suitable choice is .  By calculation we find: .           Use series to approximate the definite integral to within the indicated accuracy:  Note: The answer you derive here should be the partial sum of an appropriate series (the number of terms determined by an error estimate). This number is not necessarily the correct value of the integral truncated to the correct number of decimal places.                Use series to approximate the definite integral to within the indicated accuracy:  Note: The answer you derive here should be the partial sum of an appropriate series (the number of terms determined by an error estimate). This number is not necessarily the correct value of the integral truncated to the correct number of decimal places.                If and are the functions whose graphs are shown, let , and .  Find each of the following derivatives, if they exist. If it does not exist, enter \"dne\" (without the quotes) below.  (a)   (b)   (c)                            A car is driven at an increasing speed, starting at noon. Which of the following could be a graph of the distance the car has traveled as a function of time past noon?    1.   2.   3.   4.     5.   6.   7.   8.     figure .        SOLUTION  Because the car is driven at an increasing speed, the distance traveled for different time intervals of the same length must increase as time goes on. Therefore the slope of the graph of distance traveled must increase with increasing time, and must be 7.           Calculate the integral:          giving or Solving for and , we find and , so        "
},
{
  "id": "act-5-2-2",
  "level": "2",
  "url": "sec-act-5-2-2.html#act-5-2-2",
  "type": "Activity",
  "number": "1.6.1",
  "title": "",
  "body": "  Suppose that and .  We will explore from numerical, graphical, and algebraic perspectives.      What is the key relationship between and , according to the Second FTC?  Recall that we know a function whose derivative is , namely , but we haven't yet encountered an elementary function whose derivative is .    Recall the statement of the Second FTC.    .    , by the Second FTC.       Analyze the first derivative of algebraically to determine the intervals on which is increasing and decreasing.    Where is positive? negative?    is increasing for all ; is decreasing for    is increasing wherever is positive, so for all . Similarly, is decreasing for      Analyze the second derivative of algebraically to determine the intervals on which is concave up and concave down. Note that can be simplified to be written in the form .    Note that .    is CCU on and CCD for and .    is CCU wherever is increasing or wherever is positive. It is straightforward to show that is positive for and negative otherwise, thus is CCU on and CCD for and .      Use a Riemann sum calculator with midpoints and 10 subintervals to calculate approximate values of in the table shown below.  Note that .                     0        Remember that .                     2.35973  1.64038  0  1.64038  2.35973      , using a midpoint Riemann sum with 10 subintervals. Similarly, , and , and finally       Use your work above to sketch an accurate graph of on the axes provided below.   Axes for plotting   Axes for plotting the graph of F               Use the table of values along with the intervals where is increasing, decreasing, concave up and concave down.     Axes for plotting   Axes for plotting the graph of F    f(x)=1\/2*log(1+x^2)            Using the values and information we've found in (b)-(d), we arrive at the figure in the answer.      Now consider the function . Calculate and . Use appropriate computing technology to plot the graph of . What can you conclude about the functions and ?    Use the chain rule to calculate , and note that .     and .     The function has derivative and . As further confirmed by graphing and together, the functions and are the same function, described in different ways.    "
},
{
  "id": "csafranski__8-_6HW_prob3",
  "level": "2",
  "url": "sec-act-5-2-2.html#csafranski__8-_6HW_prob3",
  "type": "Checkpoint",
  "number": "1.6.3",
  "title": "",
  "body": "   Consider the function .  Let be the degree Taylor approximation of about .  Use 4 decimal places in your two answers below, but make sure you carry all decimals when performing calculations.  Calculate:      is an  over   under  estimate of .  Using the Lagrange Error Bound for , calculate:                         SOLUTION  The degree approximation of about is given by:   ,  ,  .  Therefore,  ,  ,  is always positive in the interval [1,1.02] so is a overestimate of .  Using the Lagrange Error Bound we find an M such that:  , where for all in the interval [1,1.02].  By examining we find that it is biggest when . Therefore, a suitable choice is .  By calculation we find: .       "
},
{
  "id": "csafranski__8-_6HW_prob4",
  "level": "2",
  "url": "sec-act-5-2-2.html#csafranski__8-_6HW_prob4",
  "type": "Checkpoint",
  "number": "1.6.4",
  "title": "",
  "body": "   Consider the function .  Let be the degree Taylor approximation of about .  Use 4 decimal places in your two answers below, but make sure you carry all decimals when performing calculations.  Calculate:      is an  over   under  estimate of .  Using the Lagrange Error Bound for , calculate:                         SOLUTION  The degree approximation of about is given by:   ,  ,  .  Therefore,  ,  ,  is always negative in the interval [8,9] so is a underestimate of .  Using the Lagrange Error Bound we find an M such that:  , where for all in the interval [8,9].  By examining we find that it is biggest when . Therefore, a suitable choice is .  By calculation we find: .       "
},
{
  "id": "csafranski__8-_6HW_prob5",
  "level": "2",
  "url": "sec-act-5-2-2.html#csafranski__8-_6HW_prob5",
  "type": "Checkpoint",
  "number": "1.6.5",
  "title": "",
  "body": "   Consider the function .  Let be the degree Taylor approximation of about .  Use 3 decimal places in your three answers below, but make sure you carry all decimals when performing calculations.  Calculate:        is an  over   under  estimate of .  Using the Lagrange Error Bound for , calculate:                              SOLUTION  The degree approximation of about is given by:   ,  ,  ,  .  Therefore,  ,  ,  ,  is always negative in the interval [1,2] so is a underestimate of .  Using the Lagrange Error Bound we find an M such that:  , where for all in the interval [1,2].  By examining we find that it is biggest when . Therefore, a suitable choice is .  By calculation we find: .       "
},
{
  "id": "csafranski__8-_6HW_prob5alt",
  "level": "2",
  "url": "sec-act-5-2-2.html#csafranski__8-_6HW_prob5alt",
  "type": "Checkpoint",
  "number": "1.6.6",
  "title": "",
  "body": "   Consider the function .  Let be the degree Taylor approximation of about .  Find:        Use 3 decimal places in your answer, but make sure you carry all decimals when performing calculations  is an (over\/under) estimate of .  If is the remainder given by the Lagrange Remainder Formula:                              SOLUTION  The degree approximation of about is given by:   ,  ,  ,  .  Therefore,  ,  ,  ,  is always negative in the interval [1,2] so is a underestimate of .  By the Legrange Remainder Theorem we know we can find an M such that:  , where for all in the interval [2,1].  By examining we find that it is biggest when . Therefore, a suitable choice is .  By calculation we find: .       "
},
{
  "id": "csafranski__8-_6HW_prob6",
  "level": "2",
  "url": "sec-act-5-2-2.html#csafranski__8-_6HW_prob6",
  "type": "Checkpoint",
  "number": "1.6.7",
  "title": "",
  "body": "   Use series to approximate the definite integral to within the indicated accuracy:  Note: The answer you derive here should be the partial sum of an appropriate series (the number of terms determined by an error estimate). This number is not necessarily the correct value of the integral truncated to the correct number of decimal places.            "
},
{
  "id": "csafranski__8-_6HW_prob7",
  "level": "2",
  "url": "sec-act-5-2-2.html#csafranski__8-_6HW_prob7",
  "type": "Checkpoint",
  "number": "1.6.8",
  "title": "",
  "body": "   Use series to approximate the definite integral to within the indicated accuracy:  Note: The answer you derive here should be the partial sum of an appropriate series (the number of terms determined by an error estimate). This number is not necessarily the correct value of the integral truncated to the correct number of decimal places.            "
...
{
  "id": "csafranski__2-_5HW_prob1",
  "level": "2",
  "url": "sec-act-5-2-2.html#csafranski__2-_5HW_prob1",
  "type": "Checkpoint",
  "number": "1.6.9",
  "title": "",
  "body": "   If and are the functions whose graphs are shown, let , and .  Find each of the following derivatives, if they exist. If it does not exist, enter \"dne\" (without the quotes) below.  (a)   (b)   (c)                        "
},
{
  "id": "csafranski__1-_1HW_prob8",
  "level": "2",
  "url": "sec-act-5-2-2.html#csafranski__1-_1HW_prob8",
  "type": "Checkpoint",
  "number": "1.6.10",
  "title": "",
  "body": "   A car is driven at an increasing speed, starting at noon. Which of the following could be a graph of the distance the car has traveled as a function of time past noon?    1.   2.   3.   4.     5.   6.   7.   8.     figure .        SOLUTION  Because the car is driven at an increasing speed, the distance traveled for different time intervals of the same length must increase as time goes on. Therefore the slope of the graph of distance traveled must increase with increasing time, and must be 7.       "
},
{
  "id": "csafranski__5-_5HW_prob2",
  "level": "2",
  "url": "sec-act-5-2-2.html#csafranski__5-_5HW_prob2",
  "type": "Checkpoint",
  "number": "1.6.11",
  "title": "",
...
{
  "id": "sec-8a-5x-preview-ww",
  "level": "1",
  "url": "sec-8a-5x-preview-ww.html",
  "type": "Section",
  "number": "1.7",
  "title": "8a-5x WeBWorK Preview",
  "body": " 8a-5x WeBWorK Preview     Consider the alternating geometric series   We want to explore how the partial sums of the series compare to and approximate the exact sum of the series, which is     Recall that the th partial sum, is the sum of the first terms of the infinite geometric series This means that   Note that the exact fractional values of    have been recorded below along with their decimal representations. Your task is to use this information to do some related computations that help us understand the behavior of the series and its partial sums.  First, by computing the differences between and for several different values of (recalling that ), fill in the first column of blank spaces provided below. Then, by viewing the series   as being in the form   fill in the last column of blank spaces.                                                                                                  What do you notice about the differences between and as the value of increases? There are at least two important things you can say.    is going up and down in absolute value as increases.    is going up in absolute value as increases.    is going down in absolute value as increases.    alternates back and forth between overestimates and underestimates.    is positive when the partial sum is an overestimate.    is always an underestimate.    is negative when the partial sum is an underestimate.    is negative when the partial sum is an overestimate.    is always an overestimate.    is positive when the partial sum is an underestimate.            What do you notice about how the differences between and compare to the value of There are at least two important things you can say.    The absolute value of is sometimes smaller than the absolute value of .    When is positive, is positive.    The absolute value of is always smaller than the absolute value of .    The absolute value of is always larger than the absolute value of .    When is negative, is positive.    When is negative, is negative.    .    When is positive, is positive.                "
},
{
  "id": "8a-5x_Preview-WW_alt-geom-series",
  "level": "2",
  "url": "sec-8a-5x-preview-ww.html#8a-5x_Preview-WW_alt-geom-series",
  "type": "Preview Activity",
  "number": "1.7.1",
  "title": "",
