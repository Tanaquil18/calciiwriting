...
},
{
  "id": "int-with-sub-ex",
  "level": "2",
  "url": "sec-partial-fractions.html#int-with-sub-ex",
  "type": "Example",
  "number": "1.2.1",
...
},
{
  ...
  "level": "2",
  "url": "sec-partial-fractions.html#multiple-choice-not-randomized",
  "type": "Checkpoint",
  "number": "1.2.3",
...
{
  "id": "multiple-choice-not-randomized-two",
  "level": "2",
  "url": "sec-partial-fractions.html#multiple-choice-not-randomized-two",
  "type": "Checkpoint",
  "number": "1.2.4",
  "title": "Powers.",
  "body": "Powers  What is the partial fraction decomposition of ?          This would be true if the exponent of the original denominator was 1 instead of 2.           This would be true if the denominator was an unfactorable quadratic instead of a power of a linear term.           This is not enough terms to account for all the possible original numerators when the denominator has a power of a linear term.           Correct!    "
},
{
  "id": "multiple-choice-not-randomized-three",
  "level": "2",
  "url": "sec-partial-fractions.html#multiple-choice-not-randomized-three",
  "type": "Checkpoint",
  "number": "1.2.5",
  "title": "Powers again.",
  "body": "Powers again  What is the partial fraction decomposition of ?          Technically correct, but not the best choice here. Look at the original numerator again.           Correct! And in fact, A=5. (If this needed to be integrated, we can use the power rule straightaway, no partial fractions work is required.)    "
},
{
  "id": "activity-2",
  "level": "2",
