...
},
{
  ...
  "number": "1.6.4",
  "title": "",
  "body": "   A car is driven at a speed that is initially high and then decreases, starting at noon. Which of the following could be a graph of the distance the car has traveled as a function of time past noon?    1.   2.   3.   4.     5.   6.   7.   8.     figure .        SOLUTION  Because the car is driven at a decreasing speed, the distance traveled for different time intervals of the same length must decrease as time goes on. Therefore the slope of the graph of distance traveled must decrease with increasing time, and must be 3.       "
},
{
